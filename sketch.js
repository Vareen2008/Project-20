...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(random(width -50, width-200),40, 10, 10);
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(random(width -50, width-200 ),40, 10, 10);
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(random(width -50, width-200),40, 10, 10);
...
function createSword(){
  ...
  var sword = createSprite(random(width -50, width-200),40, 10, 10);
